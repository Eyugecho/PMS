...
const ChangePassword = () => {
  ...
  return (
    <Grid container sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 1 }}>
          ...
          <form noValidate onSubmit={formik.handleSubmit}>
            ...
            <Grid container sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
              <Grid item xs={12} md={2.8}>
                ...
                >
                  {isChanging ? <CircularProgress size={18} sx={{ color: 'white' }} /> : 'Save changes'}
                </Button>
              </Grid>
            </Grid>
          </form>
