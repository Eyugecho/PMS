...
const AddPerpectives = ({ open, handleClose, handleSubmission, submitting }) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle variant="h4">Create New Perspective</DialogTitle>
      <DialogContent>
