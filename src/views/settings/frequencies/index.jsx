...
function Frequencies() {
  ...
  return (
    <React.Fragment>
      <PageContainer title="Frequencies" rightOption={<AddButton title="Create Frequency" variant="outlined" onPress={handleOpen} />}>
        <Grid container>
                        ...
                        >
                          ...
                          <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedIndex === index} onClose={handleMenuClose}>
                            ...
                            >
                              ...
                              <Typography variant="body2" color={theme.palette.error.main} sx={{ marginLeft: 1 }}>
                                Delete
                              </Typography>
                            </MenuItem>
                          </Menu>
